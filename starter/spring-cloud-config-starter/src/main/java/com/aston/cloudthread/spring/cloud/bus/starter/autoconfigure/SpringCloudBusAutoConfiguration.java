 ...
 */
package com.aston.cloudthread.spring.cloud.bus.starter.autoconfigure;

import com.aston.cloudthread.core.config.BootstrapConfigProperties;
import com.aston.cloudthread.spring.cloud.bus.starter.refresher.SpringCloudBusRefresherHandler;
...
public class SpringCloudBusAutoConfiguration {
    @Bean
    public SpringCloudBusRefresherHandler springCloudBusRefresherHandler(
            BootstrapConfigProperties props, Environment env) {
        return new SpringCloudBusRefresherHandler(props, env);
    }
}