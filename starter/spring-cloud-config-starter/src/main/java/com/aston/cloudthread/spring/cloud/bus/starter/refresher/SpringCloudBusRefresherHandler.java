 ...
 */
package com.aston.cloudthread.spring.cloud.bus.starter.refresher;
...
@Slf4j(topic = "CloudThreadCloudBusConfigRefresher")
public class SpringCloudBusRefresherHandler extends AbstractCloudThreadPoolRefresher
        implements ApplicationListener<EnvironmentChangeEvent> {

    private final Environment environment;

    public SpringCloudBusRefresherHandler(BootstrapConfigProperties props,
